...
const PRECACHE_URLS = [
  ...
  '/comparateur',
  '/simulateur',
  '/blog/placements-jeunes-actifs',
  '/blog/pea-explique-simplement',
  '/blog/interets-composes',
  '/blog/etf-debutant',
  '/blog/bce-hausse-taux-2026',
  '/blog/education-financiere-college',
  '/blog/apple-nouvelle-ere',
  '/blog/nvidia-premiere-capitalisation-mondiale',
  '/blog',
  OFFLINE_URL,
  '/style.css',
  '/marches.css',
  ...
  // Pastille de la navbar : présente sur les douze pages, donc précachée.
  // Sans elle, la première visite hors ligne afficherait une image cassée en
  // haut de chaque page.
  '/images/financia-mark-tile.svg',
];
